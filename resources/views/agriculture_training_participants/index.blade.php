...
<head>
    ...
    <title>View Agriculture Training Participants</title>
...
<div class="frame" style="padding-top: 70px;">
    ...
    <div class="d-flex align-items-center mb-3">
        ...
        <div class="col-md-12 text-center">
            <h2 class="header-title" style="color: green;">Agriculture Training Program – Members</h2>
        </div>
        ...
        <div>
            <div class="my-4 custom-frame">
                <div class="row">
                    ...
                    <div class="col-md-7"><p style="word-wrap: break-word; max-width: 300px;">{{ $agricultureTraining->program_name }}</p></div>
                </div>
                <div class="row">
                    <div class="col-md-5"><strong>Venue:</strong></div>
                    <div class="col-md-7"><p style="word-wrap: break-word; max-width: 300px;">{{ $agricultureTraining->venue }}</p></div>
                </div>
                <div class="row">
                    <div class="col-md-5"><strong>Date:</strong></div>
                    <div class="col-md-7"><p>{{ $agricultureTraining->date }}</p></div>
                </div>
                <div class="row">
                    <div class="col-md-5"><strong>Resource Person:</strong></div>
                    <div class="col-md-7"><p style="word-wrap: break-word; max-width: 300px;">{{ $agricultureTraining->resource_person_name }}</p></div>
                </div>
                <div class="row">
                    <div class="col-md-5"><strong>Province:</strong></div>
                    <div class="col-md-7"><p>{{ $agricultureTraining->province_name }}</p></div>
                </div>
                <div class="row">
                    <div class="col-md-5"><strong>District:</strong></div>
                    <div class="col-md-7"><p>{{ $agricultureTraining->district }}</p></div>
                </div>
            </div>
            ...
            <div class="d-flex justify-content-between mb-3">
                <a href="{{ route('agriculture-training-participants.create', $agricultureTraining->id) }}" class="btn btn-primary" style="background-color: green; border-color: green;">Add Participant</a>
                <a href="{{ route('agriculture-training-participants.download_csv', $agricultureTraining->id) }}" class="btn btn-primary" style="background-color: green; border-color: green;">Download CSV Report</a>
            </div>

            <div class="d-flex justify-content-between align-items-center mb-3">
                <form action="{{ route('agriculture-training-participants.upload_csv', $agricultureTraining->id) }}" method="POST" enctype="multipart/form-data" class="form-inline">
                    @csrf
                ...
                <form method="GET" action="{{ route('agriculture-training-participants.search', $agricultureTraining->id) }}" class="form-inline">
                    ...
                    <tbody>
                        @foreach ($participants as $participant)
                            <tr>
                                ...
                                <td>
                                    <form action="{{ route('agriculture-training-participants.destroy', [$agricultureTraining->id, $participant->id]) }}" method="POST" class="delete-participant-form" style="display: inline-block;">
                                        @csrf
                                        @method('DELETE')
