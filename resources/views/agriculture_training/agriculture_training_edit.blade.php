...
<head>
    ...
    <title>Edit Agriculture Training Program</title>
...
<div class="frame" style="padding-top: 70px;">
    ...
    <div class="right-column">
        ...
        <div class="col-md-12 text-center">
            <h2 class="header-title" style="color: green;">Edit Agriculture Training Program</h2>
        </div>
        <div class="container mt-5">
            <form method="POST" action="{{ route('agriculture-training.update', $training) }}">
                @csrf
                @method('PUT')
                <div class="row">
                    <div class="col">
