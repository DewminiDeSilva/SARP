...
<div class="frame" style="padding-top: 70px;">
    ...
    <h3 class="page-title">Annual Progress Reports</h3>
      ...
      <table class="table modern-table">
        <thead>
          <tr>
            ...
            <th style="width: 15%">Date of Submission</th>
            <th>File</th>
    ...
    <div class="mt-4 d-flex gap-2">
      <a href="{{ route('progress.annual.create') }}" class="btn-add-new">
          <i class="fas fa-plus-circle me-2"></i>Add New Annual Report
      </a>
    </div>
  </div>
  </div>
