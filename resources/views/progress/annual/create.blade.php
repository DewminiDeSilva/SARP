...
<head>
  ...
  <title>Add New Annual Progress Report</title>
  <link
...
<div class="frame" style="padding-top: 70px;">
    ...
    <h3 class="page-title">Add New Annual Progress Report</h3>

    <form action="{{ route('progress.annual.store') }}" method="POST" enctype="multipart/form-data" class="modern-form">
      @csrf
      <div class="row g-4">
        <div class="col-md-4">
