...
<head>
  ...
  <title>Quarterly Progress Reports</title>
  <link
...
<div class="frame" style="padding-top: 70px;">
    ...
    <h3 class="page-title">Quarterly Progress Reports</h3>
                ...
                <div class="modern-table-container">
                  ...
                  <table class="table modern-table">
                    ...
                    <tbody>
                      @foreach($yearReports as $r)
                        <tr>
                          <td>Q{{ $r->period_quarter }} {{ $r->period_year }}</td>
                          <td>v{{ $r->version }}</td>
                          <td>{{ $r->institution }}</td>
                  ...
                  @else
                    <div class="empty-state">
                        ...
                        <p>No quarterly reports available for {{ $y }}</p>
                    </div>
                  @endif
                </div>
            </div>
    ...
    <div class="mt-4 d-flex gap-2">
      <a href="{{ route('progress.quarterly.create') }}" class="btn-add-new">
          <i class="fas fa-plus-circle me-2"></i>Add New Quarter Report
      </a>
    </div>
  </div>
</div>
