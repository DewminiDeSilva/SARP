...
<head>
    ...
    <title>Edit 4P Training Program</title>
...
<div class="frame" style="padding-top: 70px;">
    ...
    <div class="d-flex align-items-center mb-3">
        ...
        <div class="col-md-12 text-center">
            <h2 class="header-title" style="color: green;">Edit 4P Training Program</h2>
        </div>

        <div class="container mt-5">
            <form class="form-horizontal" method="POST" action="{{ route('4p-training.update', $fourpTraining->id) }}">
                @csrf
                @method('PUT')
                ...
                <div class="row">
                    <div class="col">
                        <div class="dropdown">
                            ...
                            <input type="text" name="province_name" class="form-control" value="{{ $fourpTraining->province_name }}" readonly>
                        </div>
                    </div>
                    <div class="col">
                        <div class="dropdown">
                            <label class="form-label dropdown-label">District</label>
                            <input type="text" name="district" class="form-control" value="{{ $fourpTraining->district }}" readonly>
                        </div>
                    </div>
                    <div class="col">
                        <div class="dropdown">
                            <label class="form-label dropdown-label">DSD</label>
                            <input type="text" name="ds_division_name" class="form-control" value="{{ $fourpTraining->ds_division_name }}" readonly>
                        </div>
                    </div>
                    <div class="col">
                        <div class="dropdown">
                            <label class="form-label dropdown-label">GND</label>
                            <input type="text" name="gn_division_name" class="form-control" value="{{ $fourpTraining->gn_division_name }}" readonly>
                        </div>
                    </div>
                    <div class="col">
                        <div class="dropdown">
                            <label class="form-label dropdown-label">ASC</label>
                            <input type="text" name="as_center" class="form-control" value="{{ $fourpTraining->as_center }}" readonly>
                        </div>
                    </div>
                </div>
                ...
                <div class="container mt-3">
                    <div class="row g-3">
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" class="form-control" id="venue" name="venue" value="{{ $fourpTraining->venue }}" required>
                        </div>
                        <div class="col-md-4 mb-3">
                            <label for="program_name">Training Program Type</label>
                            <input type="text" class="form-control" id="program_name" name="program_name" value="{{ $fourpTraining->program_name }}" required>
                        </div>
                        <div class="col-md-4 mb-3">
                            <label for="program_number">Program Number</label>
                            <input type="text" class="form-control" id="program_number" name="program_number" value="{{ $fourpTraining->program_number }}" required>
                        </div>
                        <div class="col-md-4 mb-3">
                            <label for="crop_name">Crop Name</label>
                            <input type="text" class="form-control" id="crop_name" name="crop_name" value="{{ $fourpTraining->crop_name }}" required>
                        </div>
                        <div class="col-md-4 mb-3">
                            <label for="startDate">Start Date</label>
                            <input type="text" class="form-control" id="startDate" name="date" value="{{ $fourpTraining->date }}" required>
                        </div>
                        <div class="col-md-4 mb-3">
                            <label for="resource_person_name">Resource Person Name</label>
                            <input type="text" class="form-control" id="resource_person_name" name="resource_person_name" value="{{ $fourpTraining->resource_person_name }}" required>
                        </div>
                        <div class="col-md-4 mb-3">
                            <label for="training_program_cost">Training Program Cost</label>
                            <input type="text" class="form-control" id="training_program_cost" name="training_program_cost" value="{{ $fourpTraining->training_program_cost }}" required>
                        </div>
                        <div class="col-md-4 mb-3">
                            <label for="resource_person_payment">Resource Person Payment</label>
                            <input type="text" class="form-control" id="resource_person_payment" name="resource_person_payment" value="{{ $fourpTraining->resource_person_payment }}" required>
                        </div>
