...
<head>
    ...
    <title>Livestock Training Program</title>
    ...
    <div class="right-column">
        ...
        <div class="container-fluid">
            <div class="center-heading text-center">
                <h1 style="font-size: 2.5rem; color: green;">Livestock Training Program Details</h1>
            </div>
            <div class="container">
                <div class="row justify-content-center mt-4">
                    <div class="card text-center" style="width: 18rem; margin-right: 20px;">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">Total value of all livestock training program costs.</p>
                        </div>
                    </div>
                    <div class="card text-center" style="width: 18rem;">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">Total number of livestock training programs.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="d-flex justify-content-between align-items-center mb-3">
                <form action="{{ route('livestock-training.upload_csv') }}" method="POST" enctype="multipart/form-data" class="form-inline">
                    @csrf
...
$(document).ready(function() {
    $('#entriesSelect').change(function() {
        window.location = '{{ route('livestock-training.index') }}?entries=' + $(this).val();
    });
