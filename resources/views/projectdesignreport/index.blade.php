...
<head>
    ...
    <title>Project Design Report Files</title>
                ...
                <tbody>
                    @foreach($files as $file)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('projectdesignreport.download', $file->id) }}" class="btn btn-success btn-sm">
                                    Download
                                </a>
                            </td>
                            <td>
    <a href="{{ asset('storage/project_design_report/' . basename($file->file_path)) }}"
       target="_blank"
