...
<head>
    ...
    <title>View Youth Training Participants</title>
...
<div class="frame" style="padding-top: 70px;">
    ...
    <div class="d-flex align-items-center mb-3">
        ...
        <div class="col-md-12 text-center">
            <h2 class="header-title" style="color: green;">Youth Training Program Details</h2>
        </div>
        ...
        <div>
            <div class="my-4 custom-frame">
                <div class="row">
                    ...
                    <div class="col-md-7"><p style="word-wrap: break-word; max-width: 300px;">{{ $youthTraining->program_name }}</p></div>
                </div>
                <div class="row">
                    <div class="col-md-5"><strong>Venue:</strong></div>
                    <div class="col-md-7"><p style="word-wrap: break-word; max-width: 300px;">{{ $youthTraining->venue }}</p></div>
                </div>
                <div class="row">
                    <div class="col-md-5"><strong>Date:</strong></div>
                    <div class="col-md-7"><p>{{ $youthTraining->date }}</p></div>
                </div>
                <div class="row">
                    <div class="col-md-5"><strong>Resource Person:</strong></div>
                    <div class="col-md-7"><p style="word-wrap: break-word; max-width: 300px;">{{ $youthTraining->resource_person_name }}</p></div>
                </div>
                <div class="row">
                    <div class="col-md-5"><strong>Training Program Cost:</strong></div>
                    <div class="col-md-7"><p>{{ $youthTraining->training_program_cost }}</p></div>
                </div>
                <div class="row">
                    <div class="col-md-5"><strong>Resource Person Payment:</strong></div>
                    <div class="col-md-7"><p>{{ $youthTraining->resource_person_payment }}</p></div>
                </div>
                <div class="row">
                    <div class="col-md-5"><strong>Province:</strong></div>
                    <div class="col-md-7"><p>{{ $youthTraining->province_name }}</p></div>
                </div>
                <div class="row">
                    <div class="col-md-5"><strong>District:</strong></div>
                    <div class="col-md-7"><p>{{ $youthTraining->district }}</p></div>
                </div>
                <div class="row">
                    <div class="col-md-5"><strong>DS Division:</strong></div>
                    <div class="col-md-7"><p>{{ $youthTraining->ds_division_name }}</p></div>
                </div>
                <div class="row">
                    <div class="col-md-5"><strong>GN Division:</strong></div>
                    <div class="col-md-7"><p>{{ $youthTraining->gn_division_name }}</p></div>
                </div>
                <div class="row">
                    <div class="col-md-5"><strong>ASC Center:</strong></div>
                    <div class="col-md-7"><p>{{ $youthTraining->as_center }}</p></div>
                </div>
            </div>
            ...
            <div class="d-flex justify-content-between mb-3">
                ...
                <a href="{{ route('youth-training-participants.create', $youthTraining->id) }}" class="btn btn-primary" style="background-color: green; border-color: green;">Add Participant</a>
                @endif
                <a href="{{ route('youth-training-participants.download_csv', $youthTraining->id) }}" class="btn btn-primary" style="background-color: green; border-color: green;">Download CSV Report</a>
            </div>

            <div class="d-flex justify-content-between align-items-center mb-3">
                @if(auth()->user()->hasPermission('youth_training_participants', 'upload_csv'))
                <form action="{{ route('youth-training-participants.upload_csv', $youthTraining->id) }}" method="POST" enctype="multipart/form-data" class="form-inline">
                    @csrf
                ...
                @endif
                <form method="GET" action="{{ route('youth-training-participants.search', $youthTraining->id) }}" class="form-inline">
                    ...
                    <tbody>
                        @foreach ($participants as $participant)
                            <tr>
                                ...
                                <td>
                                    @if(auth()->user()->hasPermission('youth_training_participants', 'delete'))
                                    <form action="{{ route('youth-training-participants.destroy', [$youthTraining->id, $participant->id]) }}" method="POST" style="display: inline-block;">
                                        @csrf
                                        @method('DELETE')
