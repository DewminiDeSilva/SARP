...
<div class="frame">
    ...
    <div class="container mt-5 mt-1 border rounded custom-border p-4" style="box-shadow: 0 2px 12px rgba(0, 0, 0, 0.2);">
        <h3 style="font-size: 2rem; color: green;">Poultary Registration</h3>
    </br>
        <form class="form-horizontal" method="POST" action="{{ route('poultary.store') }}">
            @csrf


            <div class="col">
                    <label for="poultary_name" class="form-label dropdown-label">Poultary Name</label>
                    <input type="text" id="poultary_name" name="poultary_name" class="form-control" required>
                </div>
