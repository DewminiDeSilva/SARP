...
<div class="frame" style="padding-top: 70px;">
    ...
    <div class="container mt-5 mt-1 border rounded custom-border p-4" style="box-shadow: 0 2px 12px rgba(0, 0, 0, 0.2);">
        <h3 style="font-size: 2rem; color: green;">Homegarden Registration</h3>
    </br>
        <form class="form-horizontal" method="POST" action="{{ route('homegarden.store') }}">
            @csrf


            <div class="col">
                    <label for="homegarden_name" class="form-label dropdown-label">Homegarden Name</label>
                    <input type="text" id="homegarden_name" name="homegarden_name" class="form-control" required>
                </div>
