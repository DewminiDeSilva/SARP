...
<div class="frame">
    ...
    <div class="container mt-5 mt-1 border rounded custom-border p-4" style="box-shadow: 0 2px 12px rgba(0, 0, 0, 0.2);">
        <h3 style="font-size: 2rem; color: green;">Fruit Registration</h3>
    </br>
        <form class="form-horizontal" method="POST" action="{{ route('fruit.store') }}">
            @csrf


            <div class="col">
                    <label for="fruit_name" class="form-label dropdown-label">Fruit Name</label>
                    <input type="text" id="fruit_name" name="fruit_name" class="form-control" required>
                </div>
