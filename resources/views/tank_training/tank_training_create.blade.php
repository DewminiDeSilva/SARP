...
<head>
    ...
    <title>Tank Training Programme Registration</title>
...
<div class="frame" style="padding-top: 70px;">
    ...
    <div class="d-flex align-items-center mb-3">
        ...
        <div class="container mt-5 border rounded border-primary p-4">
            <form class="form-horizontal" method="POST" action="{{ route('tank-training.store') }}">
                @csrf
                <div class="col-md-12 text-center">
                    <h2 class="mb-4">Tank Training Programme Registration</h2>
                </div>
                ...
                <div class="row">
                    <div class="col">
                        <div class="dropdown">
                            <label for="province" class="form-label dropdown-label">Province Name <span class="text-danger">*</span></label>
                    ...
                    <div class="col">
                        <div class="dropdown">
                            <label for="district" class="form-label dropdown-label">District Name <span class="text-danger">*</span></label>
                ...
                <div class="container mt-3">
                    <div class="row g-3">
                        ...
                        <div class="col-md-4 mb-3">
                            <label for="program_name">Training Program Name <span class="text-danger">*</span></label>
                        ...
                        <div class="col-md-4 mb-3">
                            <label for="startDate">Date of Conducted <span class="text-danger">*</span></label>
