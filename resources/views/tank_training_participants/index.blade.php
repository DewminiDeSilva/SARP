...
<head>
    ...
    <title>View Tank Training Participants</title>
...
<div class="frame" style="padding-top: 70px;">
    ...
    <div class="d-flex align-items-center mb-3">
        ...
        <div class="col-md-12 text-center">
            <h2 class="header-title" style="color: green;">Tank Training Program Details</h2>
        </div>
        ...
        <div>
            <div class="my-4 custom-frame">
                <div class="row">
                    ...
                    <div class="col-md-7"><p style="word-wrap: break-word; max-width: 300px;">{{ $tankTraining->program_name }}</p></div>
                </div>
                <div class="row">
                    <div class="col-md-5"><strong>Venue:</strong></div>
                    <div class="col-md-7"><p style="word-wrap: break-word; max-width: 300px;">{{ $tankTraining->venue }}</p></div>
                </div>
                <div class="row">
                    <div class="col-md-5"><strong>Date:</strong></div>
                    <div class="col-md-7"><p>{{ $tankTraining->date }}</p></div>
                </div>
                <div class="row">
                    <div class="col-md-5"><strong>Resource Person:</strong></div>
                    <div class="col-md-7"><p style="word-wrap: break-word; max-width: 300px;">{{ $tankTraining->resource_person_name }}</p></div>
                </div>
                <div class="row">
                    <div class="col-md-5"><strong>Training Program Cost:</strong></div>
                    <div class="col-md-7"><p>{{ $tankTraining->training_program_cost }}</p></div>
                </div>
                <div class="row">
                    <div class="col-md-5"><strong>Resource Person Payment:</strong></div>
                    <div class="col-md-7"><p>{{ $tankTraining->resource_person_payment }}</p></div>
                </div>
                <div class="row">
                    <div class="col-md-5"><strong>Province:</strong></div>
                    <div class="col-md-7"><p>{{ $tankTraining->province_name }}</p></div>
                </div>
                <div class="row">
                    <div class="col-md-5"><strong>District:</strong></div>
                    <div class="col-md-7"><p>{{ $tankTraining->district }}</p></div>
                </div>
                <div class="row">
                    <div class="col-md-5"><strong>DS Division:</strong></div>
                    <div class="col-md-7"><p>{{ $tankTraining->ds_division_name }}</p></div>
                </div>
                <div class="row">
                    <div class="col-md-5"><strong>GN Division:</strong></div>
                    <div class="col-md-7"><p>{{ $tankTraining->gn_division_name }}</p></div>
                </div>
                <div class="row">
                    <div class="col-md-5"><strong>ASC Center:</strong></div>
                    <div class="col-md-7"><p>{{ $tankTraining->as_center }}</p></div>
                </div>
            </div>
            ...
            <div class="d-flex justify-content-between mb-3">
                ...
                <a href="{{ route('tank-training-participants.create', $tankTraining->id) }}" class="btn btn-primary" style="background-color: green; border-color: green;">Add Participant</a>
                @endif
                <a href="{{ route('tank-training-participants.download_csv', $tankTraining->id) }}" class="btn btn-primary" style="background-color: green; border-color: green;">Download CSV Report</a>
            </div>

            <div class="d-flex justify-content-between align-items-center mb-3">
                @if(auth()->user()->hasPermission('tank_training_participants', 'upload_csv'))
                <form action="{{ route('tank-training-participants.upload_csv', $tankTraining->id) }}" method="POST" enctype="multipart/form-data" class="form-inline">
                    @csrf
                ...
                @endif
                <form method="GET" action="{{ route('tank-training-participants.search', $tankTraining->id) }}" class="form-inline">
                    ...
                    <tbody>
                        @foreach ($participants as $participant)
                            <tr>
                                ...
                                <td>
                                    @if(auth()->user()->hasPermission('tank_training_participants', 'delete'))
                                    <form action="{{ route('tank-training-participants.destroy', [$tankTraining->id, $participant->id]) }}" method="POST" class="delete-participant-form" style="display: inline-block;">
                                        @csrf
                                        @method('DELETE')
